...
| Скиллы | `.opencode/skills/<имя>/SKILL.md` | 2.1, 2.12 |
...
> **Осторожно с путём.** Канон проекта — `.agent/skills/` (единственное число), но
> OpenCode сканирует `.agents/skills/` (множественное) и **не видит** `.agent/`.
> Варианта два: складывать скиллы в `.opencode/skills/` либо сослаться на `.agent/skills/`
> прямо из `AGENTS.md` — тогда агент прочитает их как обычные файлы проекта.
